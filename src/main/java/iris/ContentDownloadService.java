...
public interface ContentDownloadService extends java.rmi.Remote {
    ...
    iris.FetchDownloadableContentResponse fetchDownloadableContent(iris.FetchDownloadableContentRequest parameters) throws java.rmi.RemoteException, iris.ContentDownloadImageStoreFault;
